  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        resetForm();
        alert(`Location ${editingLocation ? 'updated' : 'added'} successfully!`);
      } else {
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Manage all your restaurant locations from one dashboard</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{globalAnalytics.totalOrders || 0}</p>
            </div>
          </div>
        </div>
      ...
      {locations.length > 1 && (
        <div className="bg-white rounded-lg shadow p-4">
          <div className="flex items-center space-x-4 overflow-x-auto">
            <span className="text-sm font-medium text-gray-700 whitespace-nowrap">Viewing:</span>
            {locations.map((location) => (
              ...
              >
                ...
                <span className={`w-2 h-2 rounded-full ${
                  getLocationStatus(location) === 'open' ? 'bg-green-400' : 'bg-red-400'
                }`} />
              </button>
            ))}
          </div>
      ...
      {locations.length === 0 ? (
        <div className="text-center py-12 bg-white rounded-lg shadow">
          ...
          <p className="text-gray-600 mb-6">Add your first restaurant location to get started</p>
          <button
            onClick={() => setShowAddModal(true)}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setFormData({
                    ...formData,
                    settings: { ...formData.settings, deliveryRadius: parseFloat(e.target.value) }
                  })}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setFormData({
                    ...formData,
                    settings: { ...formData.settings, minimumOrder: parseFloat(e.target.value) }
                  })}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setFormData({
                    ...formData,
                    settings: { ...formData.settings, taxRate: parseFloat(e.target.value) }
                  })}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500"
                />
              </div>
            ...
            <div className="mt-4 space-y-3">
              <label className="flex items-center">
                <input
                  ...
                  onChange={(e) => setFormData({
                    ...formData,
                    settings: { ...formData.settings, allowOnlineOrdering: e.target.checked }
                  })}
                  className="w-4 h-4 text-orange-600 rounded"
                />
              ...
              <label className="flex items-center">
                <input
                  ...
                  onChange={(e) => setFormData({
                    ...formData,
                    settings: { ...formData.settings, allowPhoneOrdering: e.target.checked }
                  })}
                  className="w-4 h-4 text-orange-600 rounded"
                />
                <span className="ml-2 text-sm text-gray-700">Allow Phone Ordering</span>
              </label>
            </div>
          </div>
        </div>
...
const LocationCard = ({ 
  ...
  return (
    <div className={`bg-white border-2 rounded-lg p-6 hover:shadow-md transition cursor-pointer ${
      ...
      <div className="grid grid-cols-2 gap-4 text-sm">
        ...
        <div>
          ...
          <p className="font-medium">{location.manager?.name || 'Unassigned'}</p>
        </div>
      </div>
    </div>
  );
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="font-medium">{location.settings?.deliveryRadius || 0} miles</p>
            </div>
            <div>
              <span className="text-sm text-gray-600">Minimum Order:</span>
              <p className="font-medium">{formatCurrency(location.settings?.minimumOrder || 0)}</p>
            </div>
            <div>
  ...
  return (
    <div className="space-y-6">
      <div className="text-center py-8">
        ...
        <h3 className="mt-2 text-sm font-medium text-gray-900">Location Settings</h3>
        <p className="mt-1 text-sm text-gray-500">
